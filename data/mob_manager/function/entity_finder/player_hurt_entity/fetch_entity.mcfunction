...
# ダメージ種別取得
    execute if entity @p[tag=AttackedPlayer,advancements={mob_manager:entity_finder/player_hurt_entity={type-melee=true}}] run data modify storage mob_manager:entity_finder DamageType set value "vanilla_melee"
    execute if entity @p[tag=AttackedPlayer,advancements={mob_manager:entity_finder/player_hurt_entity={type-projectile=true}}] run data modify storage mob_manager:entity_finder DamageType set value "vanilla_projectile"
    execute if entity @p[tag=AttackedPlayer,advancements={mob_manager:entity_finder/player_hurt_entity={type-explosion=true}}] run data modify storage mob_manager:entity_finder DamageType set value "vanilla_explosion"
    execute if entity @p[tag=AttackedPlayer,advancements={mob_manager:entity_finder/player_hurt_entity={type-other=true}}] run data modify storage mob_manager:entity_finder DamageType set value "other"
...
#    function api:mob/apply_to_forward_target/with_non-idempotent.m {CB:"mob_manager:entity_finder/player_hurt_entity/push_hurt_event",Key:"mob_manager:entity_finder/player_hurt_entity/fetch_entity",IsForwardedOnly:false}
    function mob_manager:entity_finder/player_hurt_entity/push_hurt_event
