#> blessing_engine:asset_manager/teleporter/update_activation_state/pop_master_data_from_teleporter_id
#
...
# @within function blessing_engine:asset_manager/teleporter/update_activation_state/
