#> blessing_engine:asset_manager/teleporter/tick/star_init/get_teleporters_from_group_id
#
#
#
...
#
# @within function blessing_engine:asset_manager/teleporter/tick/star_init/
