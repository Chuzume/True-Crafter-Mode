#> blessing_engine:asset_manager/teleporter/tick/star_init/
#
#
#
...
# グループIDから対象TP先を取得する
    ...
    execute if data storage asset:teleporter TargetGroupID run function blessing_engine:asset_manager/teleporter/tick/star_init/get_teleporters_from_group_id
