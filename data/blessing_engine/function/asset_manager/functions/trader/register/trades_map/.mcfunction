#> blessing_engine:asset_manager/trader/register/trades_map/
#
#
#
# @within function
#   blessing_engine:asset_manager/trader/register/set_data
#   blessing_engine:asset_manager/trader/register/trades_map/
...
# データ設定
    # buy
        ...
        function blessing_engine:asset_manager/trader/register/trades_map/item_normalize/
    ...
    # buyB
        ...
        execute if data storage asset:trader Item run function blessing_engine:asset_manager/trader/register/trades_map/item_normalize/
...
# リセット
    data remove storage asset:trader Item
# 要素残ってるなら再帰
    execute if data storage asset:trader Trades[0] run function blessing_engine:asset_manager/trader/register/trades_map/
