#> blessing_engine:asset_manager/trader/register/trades_map/item_normalize/from_artifact
#
#
#
# @within function blessing_engine:asset_manager/trader/register/trades_map/item_normalize/
