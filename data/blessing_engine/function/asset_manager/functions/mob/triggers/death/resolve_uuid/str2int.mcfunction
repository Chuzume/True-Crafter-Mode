#> blessing_engine:asset_manager/mob/triggers/death/resolve_uuid/str2int
#
#
#
# @within function blessing_engine:asset_manager/mob/triggers/death/resolve_uuid/*
...
execute if data storage asset:mob DeathLog.display.Lore[0] run function blessing_engine:asset_manager/mob/triggers/death/resolve_uuid/str2int
