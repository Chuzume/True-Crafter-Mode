...
# 殺したユーザーの特定
    ...
    execute as @a run function blessing_engine:asset_manager/mob/triggers/death/find_player
# 引数の設定
...
# contextの設定
    ...
    function blessing_engine:asset_manager/mob/triggers/death/resolve_uuid/
# トリガーの呼び出し
    function blessing_engine:asset_manager/mob/triggers/death/call
# リセット
