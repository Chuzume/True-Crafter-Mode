#> blessing_engine:asset_manager/mob/triggers/death/resolve_uuid/
#
#
#
# @within function blessing_engine:asset_manager/mob/triggers/death/

data modify storage lib: Argument.BitArray set value []
function blessing_engine:asset_manager/mob/triggers/death/resolve_uuid/str2int
