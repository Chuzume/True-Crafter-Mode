...
# トリガー処理
#
# @within function blessing_engine:asset_manager/mob/tick/
...
# トリガーの呼び出し
    function blessing_engine:asset_manager/mob/triggers/tick/
    execute if entity @s[tag=AttackingEntity] run function blessing_engine:asset_manager/mob/triggers/attack/
    execute if entity @s[tag=AttackedEntity] run function blessing_engine:asset_manager/mob/triggers/hurt/
