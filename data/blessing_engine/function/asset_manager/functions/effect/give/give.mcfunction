#> blessing_engine:asset_manager/effect/give/give
#
#
#
# @within function blessing_engine:asset_manager/effect/give/

# エフェクトがすでに付与されている場合はそれを取得する
    function blessing_engine:asset_manager/effect/common/try_pop_effect_data
# 追加するためのデータを加工する
    function blessing_engine:asset_manager/effect/give/make_effect_data
