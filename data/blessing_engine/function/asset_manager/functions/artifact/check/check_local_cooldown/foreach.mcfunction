#> blessing_engine:asset_manager/artifact/check/check_local_cooldown/foreach
#
#
#
# @within function blessing_engine:asset_manager/artifact/check/check_local_cooldown/*
...
# 要素がまだあるなら再帰
    execute if data storage asset:artifact CopiedItem[0] run function blessing_engine:asset_manager/artifact/check/check_local_cooldown/foreach
