...
# アイテム更新処理
    ...
    execute if score $Remain Temporary matches 1.. run function blessing_engine:asset_manager/artifact/use/item/update
# 破壊処理
    execute if score $Remain Temporary matches ..0 run function blessing_engine:asset_manager/artifact/use/item/break
# リセット
