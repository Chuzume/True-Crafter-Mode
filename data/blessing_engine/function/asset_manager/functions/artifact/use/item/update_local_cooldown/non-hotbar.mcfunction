#> blessing_engine:asset_manager/artifact/use/item/update_local_cooldown/non-hotbar
#
#
#
# @within function blessing_engine:asset_manager/artifact/use/item/update_local_cooldown/
...
execute if data storage asset:artifact {TargetDefaultSlot:"mainhand"} run function blessing_engine:asset_manager/artifact/use/item/update_local_cooldown/hotbar
