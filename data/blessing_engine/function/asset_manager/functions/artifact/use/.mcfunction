...
# MP減少処理
    function blessing_engine:asset_manager/artifact/use/remove_mp
# 特殊クールダウン保存
...
# すべてのアイテムについて更新処理を行う
    execute unless data storage asset:artifact {IgnoreItemUpdate:true} run function blessing_engine:asset_manager/artifact/use/item/
# リセット
