#> blessing_engine:asset_manager/artifact/create/set_cooltime
#
...
# lootする
    loot replace block 10000 0 10000 container.6 loot blessing_engine:asset_manager/artifact/generate_lore/cooldown
