#> blessing_engine:asset_manager/artifact/create/set_trigger
#
# 使用の条件を設定します
#
...
# 生成
    loot replace block 10000 0 10000 container.0 loot blessing_engine:asset_manager/artifact/generate_lore/trigger
# リセット
