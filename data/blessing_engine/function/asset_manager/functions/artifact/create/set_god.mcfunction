#> blessing_engine:asset_manager/artifact/create/set_god
#
# 使用できる神を設定します
#
...
# 生成
    loot replace block 10000 0 10000 container.8 loot blessing_engine:asset_manager/artifact/generate_lore/god
# リセット
