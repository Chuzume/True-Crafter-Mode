#> blessing_engine:asset_manager/artifact/data/current/update/when_modified/non-hotbar
#
# Itemが存在するときの更新処理
#
# @within function blessing_engine:asset_manager/artifact/data/current/update/
...
execute if data storage asset:artifact {TargetDefaultSlot:"mainhand"} run function blessing_engine:asset_manager/artifact/data/current/update/when_modified/hotbar
