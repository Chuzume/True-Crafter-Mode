#> blessing_engine:asset_manager/artifact/data/current/update/when_removed/non-hotbar
#
# Itemが削除されたときの更新処理
#
...
execute if data storage asset:artifact {TargetDefaultSlot:"mainhand"} run function blessing_engine:asset_manager/artifact/data/current/update/when_removed/hotbar
