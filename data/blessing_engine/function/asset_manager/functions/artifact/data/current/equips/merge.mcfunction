#> blessing_engine:asset_manager/artifact/data/current/equips/merge
#
# Equipments <- MaskEquips
#
# @within function
#   blessing_engine:asset_manager/artifact/data/*/revert_from_current
#   blessing_engine:asset_manager/artifact/data/current/equips/merge
...
# 要素がまだあるなら再帰
    execute if data storage asset:artifact MaskEquips[0] if data storage asset:artifact Equipments[0] run function blessing_engine:asset_manager/artifact/data/current/equips/merge
