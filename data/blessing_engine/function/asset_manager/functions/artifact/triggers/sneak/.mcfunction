#> blessing_engine:asset_manager/artifact/triggers/sneak/
#
# 各神器処理へデータ受け渡し
#
...
# スロット毎のチェック
    function blessing_engine:asset_manager/artifact/triggers/sneak/reset_when_change_item
# asset:contextにスニーク時間を設定する
    function blessing_engine:asset_manager/artifact/triggers/sneak/set_context
# 神器側に受け渡し
    # keepトリガー類
        ...
        execute if score @s Sneak matches 20.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_threshold_less
        ...
        execute if score @s Sneak matches 40.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_threshold_less
        ...
        execute if score @s Sneak matches 60.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_threshold_less
        ...
        execute if score @s Sneak matches 80.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_threshold_less
        ...
        execute if score @s Sneak matches 100.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_threshold_less
        ...
        execute if score @s Sneak matches 200.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_threshold_less
    ...
    # 単発トリガー類
        ...
        function blessing_engine:asset_manager/artifact/triggers/sneak/reset_value_not-equal
        function #asset:artifact/sneak/

        execute if score @s Sneak matches 20.. run scoreboard players set $SneakThreshold Temporary 20
        execute if score @s Sneak matches 20.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_value_not-equal
        execute if score @s Sneak matches 20.. run function #asset:artifact/sneak/1s

        execute if score @s Sneak matches 40.. run scoreboard players set $SneakThreshold Temporary 40
        execute if score @s Sneak matches 40.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_value_not-equal
        execute if score @s Sneak matches 40.. run function #asset:artifact/sneak/2s

        execute if score @s Sneak matches 60.. run scoreboard players set $SneakThreshold Temporary 60
        execute if score @s Sneak matches 60.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_value_not-equal
        execute if score @s Sneak matches 60.. run function #asset:artifact/sneak/3s

        execute if score @s Sneak matches 80.. run scoreboard players set $SneakThreshold Temporary 80
        execute if score @s Sneak matches 80.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_value_not-equal
        execute if score @s Sneak matches 80.. run function #asset:artifact/sneak/4s

        execute if score @s Sneak matches 100.. run scoreboard players set $SneakThreshold Temporary 100
        execute if score @s Sneak matches 100.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_value_not-equal
        execute if score @s Sneak matches 100.. run function #asset:artifact/sneak/5s

        execute if score @s Sneak matches 200.. run scoreboard players set $SneakThreshold Temporary 200
        execute if score @s Sneak matches 200.. run function blessing_engine:asset_manager/artifact/triggers/sneak/reset_value_not-equal
