#> blessing_engine:asset_manager/artifact/triggers/equipments/mask_slot/masking_foreach
#
#
#
# @within function blessing_engine:asset_manager/artifact/triggers/equipments/mask_slot/*
...
# 要素がまだあるなら再帰
    execute if data storage asset:artifact CopiedEquipChanges[0] if data storage asset:artifact Equipments[0] run function blessing_engine:asset_manager/artifact/triggers/equipments/mask_slot/masking_foreach
