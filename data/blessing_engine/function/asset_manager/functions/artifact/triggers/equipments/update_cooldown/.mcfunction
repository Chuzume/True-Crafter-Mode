#> blessing_engine:asset_manager/artifact/triggers/equipments/update_cooldown/
#
#
#
...
# それぞれについて更新
    function blessing_engine:asset_manager/artifact/triggers/equipments/update_cooldown/foreach
# 反転
