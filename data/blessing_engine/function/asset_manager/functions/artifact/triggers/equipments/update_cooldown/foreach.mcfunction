#> blessing_engine:asset_manager/artifact/triggers/equipments/update_cooldown/foreach
#
#
#
...
# 要素があれば再帰
    execute if data storage asset:artifact ItemData[0] run function blessing_engine:asset_manager/artifact/triggers/equipments/update_cooldown/foreach
