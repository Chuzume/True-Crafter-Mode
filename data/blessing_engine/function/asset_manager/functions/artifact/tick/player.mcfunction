#> blessing_engine:asset_manager/artifact/tick/player
#
#
#
...
# トリガー処理
    function blessing_engine:asset_manager/artifact/triggers/
...
# 神器クールダウン表示処理
    function blessing_engine:asset_manager/artifact/cooldown/
