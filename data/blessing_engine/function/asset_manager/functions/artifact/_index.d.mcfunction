#> blessing_engine:asset_manager/artifact/_index.d
# @private

#> storage
# @within *
#   blessing_engine:asset_manager/artifact/**
...
#> 特殊クールダウン
# @within function
#   blessing_engine:asset_manager/artifact/check/check_special_cooldown
#   blessing_engine:asset_manager/artifact/use/
#   blessing_engine:asset_manager/artifact/tick/
#   core:tick/
...
#> スニークの閾値用スコアホルダー
# @within function blessing_engine:asset_manager/artifact/triggers/sneak/*
...
#> クールダウン表示用
# @within function blessing_engine:asset_manager/artifact/cooldown/**
...
#> リセット用
# @within function blessing_engine:asset_manager/artifact/triggers/equipments/update_cooldown/*
