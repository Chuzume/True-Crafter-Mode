#> blessing_engine:asset_manager/artifact/cooldown/mini_bar/normalize_and_revert_lcds
#
#
#
# @within function
...
# 要素があれば再帰
    execute if data storage asset:artifact DecrementedLCDs[0] run function blessing_engine:asset_manager/artifact/cooldown/mini_bar/normalize_and_revert_lcds
