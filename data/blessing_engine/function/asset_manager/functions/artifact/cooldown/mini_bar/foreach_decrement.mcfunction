#> blessing_engine:asset_manager/artifact/cooldown/mini_bar/foreach_decrement
#
#
#
# @within function
...
# 要素があれば再帰
    execute if data storage asset:artifact LCDs[0] run function blessing_engine:asset_manager/artifact/cooldown/mini_bar/foreach_decrement
