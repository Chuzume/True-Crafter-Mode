#> blessing_engine:asset_manager/spawner/spawn/choose_mob_id/subtract_for_each
#
#
#
# @within function blessing_engine:asset_manager/spawner/spawn/choose_mob_id/*
...
# TargetWeightが0以上なら再帰
    ...
    execute if score $TargetWeight Temporary matches 0.. if data storage asset:spawner ClonedSpawnPotentials[-1] run function blessing_engine:asset_manager/spawner/spawn/choose_mob_id/subtract_for_each
