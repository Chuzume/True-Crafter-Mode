...
# Mobを召喚する
#
# @within function blessing_engine:asset_manager/spawner/tick/
...
# 召喚するMobをランダムに選択する
    function blessing_engine:asset_manager/spawner/spawn/choose_mob_id/
# 周囲のEntity数を取得する
    function blessing_engine:asset_manager/spawner/spawn/nearby_entities/get
# 再帰的にMOBを召喚する
    execute if score $NearbyEntities Temporary < $MaxNearbyEntities Temporary run function blessing_engine:asset_manager/spawner/spawn/single
