#> blessing_engine:asset_manager/spawner/spawn/nearby_entities/get_from_selector/
#
#
#
# @within function blessing_engine:asset_manager/spawner/spawn/nearby_entities/get

scoreboard players set $NearbyEntities Temporary 0
execute if score $SpawnRange Temporary matches ..320 run function blessing_engine:asset_manager/spawner/spawn/nearby_entities/get_from_selector/1-32
execute if score $SpawnRange Temporary matches 330.. run function blessing_engine:asset_manager/spawner/spawn/nearby_entities/get_from_selector/33-64
# 結果をキャッシュへ代入
