#> blessing_engine:asset_manager/spawner/subtract_hp/
#
...
# そのMobを特定/処理する
    execute as @e[type=snowball,tag=Spawner,tag=!BreakSpawner,distance=..100,sort=nearest] run function blessing_engine:asset_manager/spawner/subtract_hp/check_already_find
# リセット
