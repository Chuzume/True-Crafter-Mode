#> blessing_engine:asset_manager/spawner/register/
#
...
# スポナーの本体 // 機会があれば見た目を変えれるようにCMDを振っておく
    ...
    setblock ~ ~ ~ barrier
# データの適用
    execute positioned ~ ~0.4 ~ as @e[type=snowball,tag=SpawnerInit,distance=..0.01,limit=1] run function blessing_engine:asset_manager/spawner/register/set_data
