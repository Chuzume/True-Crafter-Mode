#> blessing_engine:asset_manager/spawner/register/set_data
#
# スポナーにデータを埋め込む
#
# @within function blessing_engine:asset_manager/spawner/register/
...
# SpawnPotentialsを正規化しWeightのSumを計算する
    function blessing_engine:asset_manager/spawner/register/process_spawn_potentials/
