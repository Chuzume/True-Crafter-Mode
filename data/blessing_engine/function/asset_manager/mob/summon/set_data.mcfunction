#> blessing_engine:asset_manager/mob/summon/set_data
#
...
# タグ周り
    function blessing_engine:asset_manager/mob/summon/set_tag
# Enemyのチーム設定
...
# ボスバーの表示
    execute if data storage asset:mob {Type:"Enemy.Boss"} run function blessing_engine:asset_manager/mob/bossbar/init
# データ初期化
