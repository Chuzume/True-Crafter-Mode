...
execute if entity @s[scores={TrueCrafterMode.Tick=40..}] if block ~ ~ ~ #t.hard:no_collision run summon armor_stand ~ ~0.68 ~ {Marker:1b,Invisible:1b,Tags:[t.hardEyeShot,t.hardShot2,t.hardShot0],DisabledSlots:4144959}
execute if entity @s[scores={TrueCrafterMode.Tick=40..}] if block ~ ~ ~ #t.hard:no_collision run playsound entity.ender_dragon.shoot hostile @p ~ ~ ~ 2 2
