...
scoreboard players set @s[tag=T.Hard_Ske_Ranged,scores={T.Hard_Moveset1=40}] Motion_Speed 8
...
scoreboard players set @s[tag=T.Hard_Ske_Melee,scores={T.Hard_Moveset1=40}] Motion_Speed 8
