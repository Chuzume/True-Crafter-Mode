...
execute if entity @s[tag=T.Hard_Place_Down] if block ~ ~-1 ~ #t.hard:can_place run playsound minecraft:block.stem.place block @a ~ ~ ~ 1.5 1
execute if entity @s[tag=T.Hard_Place_Down] if block ~ ~-1 ~ #t.hard:can_place run setblock ~ ~-1 ~ crimson_hyphae
execute if entity @s[tag=T.Hard_Place_Down] positioned ~ ~-1 ~ if block ~ ~ ~ crimson_hyphae unless entity @e[tag=T.Hard_Enemy_Block_Nether,distance=..0.5] align xyz run summon minecraft:item_frame ~0.5 ~ ~0.5 {Invisible:1b,Silent:1b,Fixed:1b,Tags:["T.Hard_Enemy_Block_Nether"]}
...
execute if entity @s[scores={T.Hard_Y_Check=0},nbt={OnGround:1b}] rotated ~ 0 positioned ^ ^ ^1 if block ~ ~-1 ~ #t.hard:can_place if block ~ ~-2 ~ #t.hard:can_place run setblock ~ ~-1 ~ crimson_hyphae
execute if entity @s[scores={T.Hard_Y_Check=0},nbt={OnGround:1b}] rotated ~ 0 positioned ^ ^-1 ^1 if block ~ ~ ~ crimson_hyphae unless entity @e[tag=T.Hard_Enemy_Block_Nether,distance=..0.5] align xyz run summon minecraft:item_frame ~0.5 ~ ~0.5 {Invisible:1b,Silent:1b,Fixed:1b,Tags:["T.Hard_Enemy_Block_Nether"]}