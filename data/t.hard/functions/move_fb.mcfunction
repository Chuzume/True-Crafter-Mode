...
execute as @s store result entity @s direction[0] double -0.01 run scoreboard players get @s Motion_Power
...
execute as @s at @s positioned ^ ^ ^0.1 run scoreboard players operation @s Motion_Power -= @e[tag=pos,limit=1,sort=nearest] Motion_Power
scoreboard players operation @s Motion_Power *= @s ChuzSpeed
execute as @s store result entity @s direction[1] double -0.01 run scoreboard players get @s Motion_Power
...
execute as @s at @s positioned ^ ^ ^0.1 run scoreboard players operation @s Motion_Power -= @e[tag=pos,limit=1,sort=nearest] Motion_Power
scoreboard players operation @s Motion_Power *= @s ChuzSpeed
execute as @s store result entity @s direction[2] double -0.01 run scoreboard players get @s Motion_Power
