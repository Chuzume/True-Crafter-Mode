...
# 足を止めている間スコアを加算し、一定に達するとブロック設置。ただし、橋モードのときはやらない
    execute if entity @s[tag=Standstill,tag=!abstract.chaser_ai.Bridge] unless score @s abstract.chaser_ai.Place matches 1.. unless score @s abstract.chaser_ai.PlaceStart matches 40.. run scoreboard players add @s abstract.chaser_ai.PlaceStart 1 
