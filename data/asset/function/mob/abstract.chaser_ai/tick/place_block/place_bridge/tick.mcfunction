...
# 水平方向に設置
    execute if block ^ ^-1 ^1 #lib:can_place if block ~ ~-2 ~ #lib:can_place positioned ^ ^-1 ^1 align xyz positioned ~0.5 ~0.5 ~0.5 run function api:object/summon.m {ID:"gimmick.enemy_block"}
    execute if block ^ ^-1 ^2 #lib:can_place if block ~ ~-2 ~ #lib:can_place positioned ^ ^-1 ^2 align xyz positioned ~0.5 ~0.5 ~0.5 run function api:object/summon.m {ID:"gimmick.enemy_block"}
