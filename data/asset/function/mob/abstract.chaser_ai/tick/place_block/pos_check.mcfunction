...
# 差が-1..0、つまり大体同じ高さなら
    execute if entity @s[tag=!abstract.chaser_ai.Bridge,scores={abstract.chaser_ai.PosCheckY=-1..0},tag=OnGround] run function asset:mob/abstract.chaser_ai/tick/place_block/place_bridge/start
