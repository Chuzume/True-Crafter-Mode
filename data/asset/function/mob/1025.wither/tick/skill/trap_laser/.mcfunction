...
# 数Tickごとに召喚だ～
    execute if score @s 1025.Phase matches 1 run scoreboard players operation $Interval Temporary %= $10 Const
    execute if score @s 1025.Phase matches 2.. run scoreboard players operation $Interval Temporary %= $5 Const
