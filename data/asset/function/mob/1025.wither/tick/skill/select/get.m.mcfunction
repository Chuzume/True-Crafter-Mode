#> asset:mob/1025.wither/tick/skill/select/get.m
#
# 
#
# @within function asset:mob/1025.wither/tick/skill/select/roll.m

# Skill.Listの要素を番号で指定
    $data modify storage asset:context this.Skill.Get set from storage asset:context this.Skill.List[-$(Roll)]

# 技を選択、属性ごとに違う
    function asset:mob/1025.wither/tick/skill/select/tags
