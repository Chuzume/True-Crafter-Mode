#> asset:mob/1020.slime/tick/
#
# Mobのtick時の処理
#
# @within asset:mob/alias/1020/tick

# 敵対時の処理
    execute if predicate true_crafter_mode:in_hostile run scoreboard players add @s General.Mob.Tick 1
