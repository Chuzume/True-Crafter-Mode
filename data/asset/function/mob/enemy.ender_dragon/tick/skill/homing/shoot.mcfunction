#> asset:mob/enemy.ender_dragon/tick/skill/homing/shoot
#
# 
#
# @within function asset:mob/enemy.ender_dragon/tick/skill/homing/
...
# 召喚
    data modify storage api: Argument.FieldOverride set value {Speed:1,Range:300,MovePerStep:0.5}
