#> asset:mob/enemy.ender_dragon/tick/skill/charge/
#
# なつかしの突進攻撃
#
...
# 突進開始時、自分用のマーカーを出す
    execute if score @s General.Mob.Tick matches 0 run function asset:mob/enemy.ender_dragon/tick/skill/charge/start
...
# 解除
    execute if score @s General.Mob.Tick matches 70 run function asset:mob/enemy.ender_dragon/tick/skill/charge/end
...
# リセット
    execute if score @s General.Mob.Tick matches 100.. run function asset:mob/enemy.ender_dragon/tick/reset
