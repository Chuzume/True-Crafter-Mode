#> asset:mob/enemy.ender_dragon/tick/skill/aiming_eyes/summon
#
# 
#
...
# 召喚
    ...
    execute at @n[type=marker,tag=SpreadMarker,distance=..128] facing entity @p eyes run function api:object/summon.m {ID:"projectile.ender_eye_laser"}
