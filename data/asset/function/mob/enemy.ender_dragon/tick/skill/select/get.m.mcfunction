#> asset:mob/enemy.ender_dragon/tick/skill/select/get.m
#
# 
#
# @within function asset:mob/enemy.ender_dragon/tick/skill/select/roll.m

# Skill.Listの要素を番号で指定
    $data modify storage asset:context this.Skill.Get set from storage asset:context this.Skill.List[-$(Roll)]

# 技を選択
    function asset:mob/enemy.ender_dragon/tick/skill/select/tags
