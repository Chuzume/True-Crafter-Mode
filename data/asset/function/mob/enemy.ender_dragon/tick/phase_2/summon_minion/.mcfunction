...
# カウント数が一定以下であれば実行
    execute if score $MinionCount Temporary matches ..3 at @n[type=marker,tag=enemy.ender_dragon.Marker.Origin,distance=..128] positioned ~ ~24 ~ run function asset:mob/enemy.ender_dragon/tick/phase_2/summon_minion/active
