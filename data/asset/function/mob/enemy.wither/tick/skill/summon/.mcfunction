...
# しもべが残ってたらそいつを爆発させる
    execute if score @s General.Mob.Tick matches 0 as @e[type=wither_skeleton,scores={MobID=1028},distance=..32,limit=3] at @s run function asset:mob/enemy.wither/tick/skill/summon/explosion
