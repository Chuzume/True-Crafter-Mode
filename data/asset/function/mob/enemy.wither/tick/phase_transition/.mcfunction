...
# 付近の下っ端がいなくなったら行動を再開
    execute if score @s General.Mob.Tick matches 90..839 unless entity @e[type=wither_skeleton,distance=..64,scores={MobID=1027}] run function asset:mob/enemy.wither/tick/phase_transition/minion_cleared
