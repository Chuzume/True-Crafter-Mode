#> asset:mob/enemy.piglin_sword/tick/fire_resist/start
#
# 
#
...
#近くに敵がいるなら飛び退く
    execute if entity @n[tag=TMCM.Target,distance=..7] run function asset:mob/enemy.piglin_sword/tick/back_step
