#> asset:mob/1023.zombie_brute/in_hostile/
#
# 継承先などから実行される処理
#
# @within asset:mob/alias/1023/in_hostile
...
# 突進攻撃
    # 予備動作
        execute if score @s General.Mob.Tick matches 70 run function asset:mob/1023.zombie_brute/in_hostile/windup
    # 開始
        execute if score @s General.Mob.Tick matches 80 run function asset:mob/1023.zombie_brute/in_hostile/strong_walk/start
    # 効果中
        execute if score @s General.Mob.Tick matches 80..160 run function asset:mob/1023.zombie_brute/in_hostile/strong_walk/tick
    # 終了
        execute if score @s General.Mob.Tick matches 160 run function asset:mob/1023.zombie_brute/in_hostile/strong_walk/reset
