#> asset:mob/enemy.wither_knight/shot/convert
#
# 
#
...
# 召喚
    execute facing entity @n[tag=TMCM.Target,distance=..32] eyes run function api:object/summon.m {ID:"projectile.elite_wither_arrow"}
