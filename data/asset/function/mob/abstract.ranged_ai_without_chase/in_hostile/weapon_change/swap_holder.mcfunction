#> asset:mob/ranged_ai_without_chase/in_hostile/weapon_change/swap_holder
#
# アイテムホルダーのアイテムと交換する
#
# @within function asset:mob/ranged_ai_without_chase/in_hostile/weapon_change/melee
