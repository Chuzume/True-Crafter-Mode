...
# 手持ちをストレージに移す
    data modify storage asset:temp SheathItem set from entity @s equipment.mainhand
...
# 腰のアイテムをさっきまで持ってたものに変える
    data modify entity @n[type=item_display,tag=Object.other.sheath] item set from storage asset:temp SheathItem

# リセット
    data remove storage asset:temp SheathItem
