#> asset:mob/enemy.bogged_elite/init/
#
# Mobのinit時の処理
#
...
# ステータス
    data modify entity @s CustomName set value {"fallback":"エリートボグド","translate":"entity.true_crafter_mode.bogged_elite"}
...
# 頭装備
    item replace entity @s armor.head with player_head[profile={id:[I;-325901202,1717190863,-1098867190,1170106406],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTNkNWEyMGMzMDYxZGUwZDlkODQzMWM5YjkyZDlkYzMzNjc4Mzk2MzRhOTUxMzAzYWVmMWU1ZDU5NzNjNGJhMSJ9fX0="}]}]
# 胴装備
    #item replace entity @s armor.chest with iron_chestplate
    item replace entity @s armor.chest with leather_chestplate[dyed_color=5468202,trim={material:"minecraft:redstone",pattern:"minecraft:shaper"}]
# 脚装備
