...
# そろそろ消えるぞ…
    execute if score @s General.Object.Tick matches 240.. run particle dust{color:[0.8,0.2,1.0],scale:2} ~ ~ ~ 2 2 2 0 2 force @a[distance=..16]

# 足場消える
    execute if score @s General.Object.Tick matches 300 run function asset:object/2006.dragon_platform/tick/break
