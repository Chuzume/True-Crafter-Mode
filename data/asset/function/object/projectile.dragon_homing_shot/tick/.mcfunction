#> asset:object/projectile.dragon_homing_shot/tick/
#
# Objectのtick時の処理
#
...
# 誘導！
    execute unless score @s General.Object.Tick matches 35.. facing entity @p[distance=..128] feet positioned ^ ^ ^-10 rotated as @s positioned ^ ^ ^-40 facing entity @s feet positioned as @s run tp @s ~ ~ ~ ~ ~
