#> asset:object/projectile.ender_eye_laser/tick/laser/alert
#
# 予告レーザー
#
# @within function 
...
# 再帰
    execute if entity @s[distance=..32] positioned ^ ^ ^1 run function asset:object/projectile.ender_eye_laser/tick/laser/alert
