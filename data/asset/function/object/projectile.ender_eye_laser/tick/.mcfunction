...
# 発射
    execute if score @s General.Object.Tick matches 60 run function asset:object/projectile.ender_eye_laser/tick/laser/shoot

# 消える
    execute if score @s General.Object.Tick matches 80.. run function asset:object/projectile.ender_eye_laser/tick/death
