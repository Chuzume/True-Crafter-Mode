#> asset:object/projectile.wither_trap_laser/tick/laser/
#
# 
#
# @within 
#   function asset:object/projectile.wither_trap_laser/tick/
#   asset:object/projectile.wither_trap_laser/tick/laser/
# パーティクル
...
# ダメージ
    execute positioned ~-0.5 ~-0.5 ~-0.5 as @a[dx=0] positioned ~0.5 ~0.5 ~0.5 run function asset:object/projectile.wither_trap_laser/tick/laser/damage
...
#    execute if entity @s[distance=..32] positioned ~-0.5 ~-0.5 ~-0.5 unless entity @a[tag=!PlayerShouldInvulnerable,dx=0] positioned ~0.5 ~0.5 ~0.5 positioned ^ ^ ^1 if block ~ ~ ~ #lib:no_collision run function asset:mob/1004.tultaria/tick/skill/thunder/aiming_laser/laser/
    execute if entity @s[distance=..32] positioned ^ ^ ^1 if block ~ ~ ~ #lib:no_collision run function asset:object/projectile.wither_trap_laser/tick/laser/
