#> asset:object/projectile.wither_homing_shot/tick/
#
# Objectのtick時の処理
#
...
# 誘導！
    execute unless score @s General.Object.Tick matches 35.. facing entity @p[tag=!PlayerShouldInvulnerable,distance=..48] eyes positioned ^ ^ ^-10 rotated as @s positioned ^ ^ ^-40 facing entity @s feet positioned as @s run tp @s ~ ~ ~ ~ ~
