...
# Contextの設定
    ...
    data modify storage asset:context id set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ObjectID
    data modify storage asset:context originID set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].ObjectID
