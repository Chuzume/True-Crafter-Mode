...
# 耐火ポーション飲み終わり
    execute if entity @s[tag=TMCM.Piglin.F.Resist,scores={T.HardMoveset2=30}] run function true_crafter_mode:enemy/piglin/fire_resist_finish
...
# t.hard_Piglin_Healタグ持ってれば肉食う
    ...
    effect give @s[tag=TMCM.Piglin.Heal,scores={T.HardMoveset2=20}] instant_health 2 1
# 回復完了
    execute if entity @s[tag=TMCM.Piglin.Heal,scores={T.HardMoveset2=30}] run function true_crafter_mode:enemy/piglin/heal_finish
