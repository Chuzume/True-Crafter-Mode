...
execute unless entity @e[type=#true_crafter_mode:piglin_enemy,tag=!TMCM.Exception,distance=..25] run tag @s remove T.HardNoF.Resist

#着火したら耐火ポーション使用
execute if entity @s[nbt=!{Fire:-1s},tag=!TMCM.Piglin.F.Resist] if entity @s[nbt=!{ActiveEffects:[{Id:12b}]},tag=!T.HardNoF.Resist] run function true_crafter_mode:enemy/piglin/potion_fire_resist
#t.hard_Piglin_F.Resistタグ持ってればポーションを飲む
scoreboard players add @s[tag=TMCM.Piglin.F.Resist] T.HardMoveset2 1
execute if entity @s[tag=TMCM.Piglin.F.Resist,scores={T.HardMoveset2=10}] run playsound minecraft:entity.generic.drink hostile @a ~ ~ ~ 1 1
execute if entity @s[tag=TMCM.Piglin.F.Resist,scores={T.HardMoveset2=20}] run playsound minecraft:entity.player.burp neutral @a ~ ~ ~ 1 1
effect give @s[tag=TMCM.Piglin.F.Resist,scores={T.HardMoveset2=20}] fire_resistance 120 0 
#耐火ポーション飲み終わり
execute if entity @s[tag=TMCM.Piglin.F.Resist,scores={T.HardMoveset2=30}] run function true_crafter_mode:enemy/piglin_brute/fire_resist_finish
...
scoreboard players add @s[tag=TMCM.Piglin.Heal] T.HardMoveset2 1
execute if entity @s[tag=TMCM.Piglin.Heal,scores={T.HardMoveset2=10}] run playsound minecraft:entity.generic.eat hostile @a ~ ~ ~ 1 1
execute if entity @s[tag=TMCM.Piglin.Heal,scores={T.HardMoveset2=20}] run playsound minecraft:entity.player.burp neutral @a ~ ~ ~ 1 1
effect give @s[tag=TMCM.Piglin.Heal,scores={T.HardMoveset2=20}] instant_health 1 1
#ごはん食べ終わり
execute if entity @s[tag=TMCM.Piglin.Heal,scores={T.HardMoveset2=30}] run function true_crafter_mode:enemy/piglin_brute/heal_finish
