...
execute as @e[type=piglin,distance=..60] at @s run data modify entity @s Brain.memories."minecraft:angry_at".value set from entity @e[type=#true_crafter_mode:piglin_enemy,tag=!T.HardException,limit=1,sort=nearest] UUID
