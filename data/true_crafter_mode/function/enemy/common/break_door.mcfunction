#松明も壊す
execute store success score @s T.HardTorch store success score @s T.HardTorch run fill ~-1 ~ ~-1 ~1 ~1 ~1 minecraft:air replace #true_crafter_mode:torches
...
execute store success score @s T.HardDoor3 run fill ~-1.5 ~ ~-1.5 ~1.5 ~1 ~1.5 minecraft:air replace #true_crafter_mode:fence_gates
