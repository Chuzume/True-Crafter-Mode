...
# Y座標がプレイヤーのほうが高く、自分が止まっているならブロック設置
    ...
    execute if entity @s[scores={TrueCrafterMode.BlockPlace=0..}] if block ~ ~-1 ~ #true_crafter_mode:can_place positioned ~ ~-1 ~ run function true_crafter_mode:enemy/block/nether/place
