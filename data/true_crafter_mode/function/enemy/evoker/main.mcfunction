...
execute if entity @s[scores={T.HardMoveset1=40}] if entity @a[distance=..5] rotated ~ 0 if block ^ ^ ^-1 #true_crafter_mode:no_collision run function true_crafter_mode:enemy/common/back_warp
execute if entity @s[scores={T.HardMoveset1=40}] if entity @a[distance=..5] rotated ~ 0 unless block ^ ^ ^-1 #true_crafter_mode:no_collision run function true_crafter_mode:enemy/common/foward_warp
execute if entity @s[scores={T.HardMoveset1=40}] if entity @a[distance=5..16] rotated ~ 0 run function true_crafter_mode:enemy/common/foward_warp
