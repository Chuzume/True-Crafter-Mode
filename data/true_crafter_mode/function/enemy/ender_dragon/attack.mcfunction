...
execute if entity @a[tag=!TrueCrafterMode.Exception,distance=0..] run scoreboard players add @s TrueCrafterMode.Tick 1

#3wayショット Dra0
tag @s[scores={TrueCrafterMode.Tick=40..},nbt={DragonPhase:0}] add T.HardDra0
...
scoreboard players reset @s[tag=T.HardDra0] TrueCrafterMode.Tick
tag @s[tag=T.HardDra0] remove T.HardDra0

#でっかい爆発を起こす火の玉 Dra1
tag @s[scores={TrueCrafterMode.Tick=40..},nbt={DragonPhase:1}] add T.HardDra1
...
scoreboard players reset @s[tag=T.HardDra1] TrueCrafterMode.Tick
tag @s[tag=T.HardDra1] remove T.HardDra1

#どらごんさんだー Dra2 長引いた場合はショットへ戻る
execute unless entity @s[scores={T.HardMoveset2=6..}] run tag @s[scores={TrueCrafterMode.Tick=40..},nbt={DragonPhase:2}] add T.HardDra2
execute if entity @s[scores={T.HardMoveset2=6..}] run tag @s[scores={TrueCrafterMode.Tick=40..},nbt={DragonPhase:2}] add T.HardDra0
...
scoreboard players reset @s[tag=T.HardDra2] TrueCrafterMode.Tick
