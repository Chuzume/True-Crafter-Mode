...
execute if entity @s[scores={TrueCrafterMode.Tick=40}] at @e[distance=..2] run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0f,Duration:6,Age:4,Effects:[{Id:25b,Amplifier:20b,Duration:9,ShowParticles:0b}]}
