...
execute if entity @a[tag=!TMCM.Exception,distance=5..20] run scoreboard players add @s TMCM.Tick 1 
execute if entity @s[scores={TMCM.Tick=40..}] if block ~ ~ ~ #true_crafter_mode:no_collision run summon armor_stand ~ ~0.68 ~ {Marker:1b,Invisible:1b,Tags:[t.hardEyeShot,t.hardShot2,t.hardShot0],DisabledSlots:4144959}
execute if entity @s[scores={TMCM.Tick=40..}] if block ~ ~ ~ #true_crafter_mode:no_collision run playsound entity.ender_dragon.shoot hostile @p ~ ~ ~ 2 2
scoreboard players reset @s[scores={TMCM.Tick=40..}]
=======
execute if entity @a[tag=!TMCM.Exception,distance=5..20] run scoreboard players add @s TMCM.Tick 1 
execute if entity @s[scores={TMCM.Tick=40..}] if block ~ ~ ~ #true_crafter_mode:no_collision run summon armor_stand ~ ~0.68 ~ {Marker:1b,Invisible:1b,Tags:[T.HardEyeShot,T.HardShot2,T.HardShot0],DisabledSlots:4144959}
execute if entity @s[scores={TMCM.Tick=40..}] if block ~ ~ ~ #true_crafter_mode:no_collision run playsound entity.ender_dragon.shoot hostile @p ~ ~ ~ 2 2
