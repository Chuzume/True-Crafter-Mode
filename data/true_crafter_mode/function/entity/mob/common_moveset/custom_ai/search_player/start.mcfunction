...
# 頭に置く用のちいちゃいピグリンを呼ぶ
    summon piglin ~ ~ ~ {Silent:1b,Invulnerable:1b,IsImmuneToZombification:1b,Tags:["TMCM.PiglinAI","TMCM.PiglinAI.Search","Chuz.Init","Chuz.NonVanillaMob"],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:0b}],attributes:[{id:"minecraft:generic.scale",base:0.0625},{id:"minecraft:generic.step_height",base:10}]}
# 召喚したのを頭に置く
