...
# 腰にアイテム装着する
    summon item_display ~ ~ ~ {teleport_duration:1,Tags:["TrueCrafterMode.Other.Sheath","Chuz.Init"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,-2.4f,1f],translation:[0f,-1.1f,-0.3f],scale:[1f,1f,1f]},item:{id:"minecraft:stone_axe",count:1}}
