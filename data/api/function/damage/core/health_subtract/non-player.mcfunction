...
# ノックバックを無効に
    attribute @s minecraft:knockback_resistance modifier add 3-0-1-0-100000001 "Temp_Resist" 1 add
# 敵対させるためのダメージ
...
# ノックバック無効を削除
    attribute @s minecraft:knockback_resistance modifier remove 3-0-1-0-100000001
# 代入 / kill
