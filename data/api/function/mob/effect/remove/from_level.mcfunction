#> api:mob/effect/remove/from_level
#
...
# 呼び出し
    function api:mob/apply_to_forward_target/with_non-idempotent.m {CB:"api:mob/effect/core/remove/from_level/",Key:"api:mob/effect/remove/from_level",IsForwardedOnly:true}
