#> api:mob/effect/core/remove/from_level/recursion
#
#
#
# @within function
#   api:mob/effect/core/remove/from_level/
#   api:mob/effect/core/remove/from_level/recursion
...
# 残っていたら再帰
    ...
    execute unless score $ClearCount Temporary matches ..0 if data storage asset:effect IDList[0] run function api:mob/effect/core/remove/from_level/recursion
