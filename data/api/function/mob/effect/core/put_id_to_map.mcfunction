#> api:mob/effect/core/put_id_to_map
#
#
#
# @within function api:mob/effect/core/*
...
# まだExtendsが残っていれば再帰する
    execute if data storage asset:effect Extends[0] run function api:mob/effect/core/put_id_to_map
