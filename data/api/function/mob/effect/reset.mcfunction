...
# リセット
    ...
    function api:mob/apply_to_forward_target/reset_initial_apply.m {Key:"api:mob/effect/give"}
    function api:mob/apply_to_forward_target/reset_initial_apply.m {Key:"api:mob/effect/remove/from_id"}
    function api:mob/apply_to_forward_target/reset_initial_apply.m {Key:"api:mob/effect/remove/from_level"}
