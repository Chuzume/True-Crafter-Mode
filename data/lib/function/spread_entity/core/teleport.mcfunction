...
# X-
    execute store result score $SubX Temporary run random value 0..65534
...
# X+
    execute store result score $AddX Temporary run random value 0..65534
...
# Y-
    execute store result score $SubY Temporary run random value 0..65534
...
# Y+
    execute store result score $AddY Temporary run random value 0..65534
...
# Z-
    execute store result score $SubZ Temporary run random value 0..65534
...
# Z+
    execute store result score $AddZ Temporary run random value 0..65534
